...
function display(){
    ...
    document.getElementById("today-condition-img").setAttribute("src","https://"+data.forecast.forecastday[0].day.condition.icon)
    document.getElementById("today-temp").innerHTML = data.forecast.forecastday[0].day.avgtemp_c+" °C"
    document.getElementById("today-condition-text").innerHTML = data.forecast.forecastday[0].day.condition.text
    // date tomorrow
